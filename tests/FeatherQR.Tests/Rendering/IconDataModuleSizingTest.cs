...
public class IconDataModuleSizingTest
{
    ...
    public async Task GetIconRects_ModuleSizing_WithIntegerModulePixels_AlignsToModules()
    {
        ...
        var qrData = QRCodeGenerator.Create(TestContent, QREccLevel.H, new QRCodeGeneratorOptions { Version = 1, QuietZoneSize = 4 });
    ...
    public async Task GetIconRects_ModuleSizing_EvenIconSize_SnapsToModuleGrid()
    {
        ...
        var qrData = QRCodeGenerator.Create(TestContent, QREccLevel.H, new QRCodeGeneratorOptions { Version = 5, QuietZoneSize = 4 });
        var imageSide = qrData.Size * modulePixelSize;
        var area = SKRect.Create(0, 0, imageSide, imageSide);
    ...
    {
        var qrData = QRCodeGenerator.Create(TestContent, QREccLevel.H, new QRCodeGeneratorOptions { Version = 1, QuietZoneSize = 0 });
        ...
        var ex = Assert.Throws<InvalidOperationException>(() => SymbolRenderer.GetIconRects(qrData, area, icon));
