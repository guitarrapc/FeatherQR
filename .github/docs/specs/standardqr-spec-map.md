...
| - | Regional binarization when the global threshold reads nothing in either polarity (8 × 8 blocks, each pixel against the mean black point of the 5 × 5 around its block; skipped when it agrees with the global threshold on every pixel), shared across symbologies, with a 128-bit tier for its three passes; Micro QR and rMQR scan it strided only, without the full-sweep retry of the global attempts | [LocalBinarizer](../../../src/FeatherQR/Internals/ImageDecoders/LocalBinarizer.cs); parity: [LocalBinarizerParityTest](../../../tests/FeatherQR.Tests/Shared/LocalBinarizerParityTest.cs), decode: [UnevenLightingDecodeTest](../../../tests/FeatherQR.Tests/Shared/UnevenLightingDecodeTest.cs) |
