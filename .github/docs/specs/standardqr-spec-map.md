...
| - | Module-size measurement, dimension estimation | [QRImageDecoder](../../../src/FeatherQR/Internals/StandardQR/QRImageDecoder.cs) |

Reference tests: [QRCodeDecoderRoundTripTest](../../../tests/FeatherQR.Tests/StandardQr/QRCodeDecoderRoundTripTest.cs) (encode→decode round-trips, error injection), [EccBinaryDecoderUnitTest](../../../tests/FeatherQR.Tests/Shared/EccBinaryDecoderUnitTest.cs) (correction capacity boundaries), [QRCodeDecoderZXingCrossTest](../../../tests/FeatherQR.Tests/StandardQr/QRCodeDecoderZXingCrossTest.cs) (independent-encoder cross-validation), [QRCodeDecoderImageTest](../../../tests/FeatherQR.Tests/StandardQr/QRCodeDecoderImageTest.cs) (rotation/mirror/scale/inversion image cases), [QRCodeDecoderPerspectiveTest](../../../tests/FeatherQR.Tests/StandardQr/QRCodeDecoderPerspectiveTest.cs) (keystone envelope, rotation+perspective combinations), [BitReaderParityTest](../../../tests/FeatherQR.Tests/Shared/BitReaderParityTest.cs) (the 64-bit window reader against the bit-by-bit definition, shared across symbologies), [ByteSegmentCharsetParityTest](../../../tests/FeatherQR.Tests/Shared/ByteSegmentCharsetParityTest.cs) (byte-segment charset rule over an exhaustive short-sequence corpus, both UTF-8 implementations and the planner mirror), [QRBinaryDecoderTruncationTest](../../../tests/FeatherQR.Tests/StandardQr/QRBinaryDecoderTruncationTest.cs) (every mode cut at every byte).
