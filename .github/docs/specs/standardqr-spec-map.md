...
| - | Binarization (Otsu) | [Binarizer](../../../src/FeatherQR/Internals/ImageDecoders/Binarizer.cs), shared across symbologies: the histogram fill has a 256-bit tier that counts the two extreme values in registers and a scalar walk, the threshold search and the grey levels read the histogram alone; parity: [OtsuHistogramParityTest](../../../tests/FeatherQR.Tests/Shared/OtsuHistogramParityTest.cs) (every bin, each tier entered directly), [OtsuThresholdParityTest](../../../tests/FeatherQR.Tests/StandardQr/OtsuThresholdParityTest.cs) |
